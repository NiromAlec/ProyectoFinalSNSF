...
public class ProductoTest {
    ...
    public void regirtrarTest(){
        ...
        Producto producto= new Producto("arequipe", 10, "arequipe de queso",5000.0,LocalDateTime.now(), 0.5,  usuario,ciudad);
    ...
    public void eliminarTest(){
        ...
        Producto productoBuscado= productoRepo.findById(2).orElse(null);
