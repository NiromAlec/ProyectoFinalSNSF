...
insert into producto values ("111", "Lleno de potacio", 0.2, "2022/10/19", "Banano","Promo", 750.0, 10, 2, "123");
insert into producto values ("222", "Lleno de fibra", 0.3, "2022/10/30", "Carne","Promo", 5000.0, 5000, 1, "456");
insert into producto values ("333", "Lleno de hierro", 0.4, "2025/10/30", "Cereal", "Promo", 8000.0, 5000, 3, "456");
...
insert into chat values ("200","222","456");
insert into chat values ("300","111","789");
