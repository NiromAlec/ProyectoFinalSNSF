...
public class ProductoServicioTest {
    ...
    public void obtenerProductoTest(){
        try {
            ...
            Producto producto = new Producto("6161","TV", 2, "444", 4.500000, ldt, 1.5, vendedor, null);
    ...
    public void comentarProductoTest(){
        ...
        LocalDateTime ldt = LocalDateTime.of(2021, 11, 25, 20, 10);
            Producto producto = new Producto("6162","TV", 2, "444", 4.500000, ldt, 1.5, vendedor, null);
        try {
            Producto publicado= productoServicio.publicarProducto(producto);
        } catch (Exception e) {
            e.printStackTrace();
